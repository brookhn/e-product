...
public enum ErrorCode implements ErrorMethod, Serializable {
    ...
    GOODS_COMB_NO_EXIST(3006, "商品组合关系不存在"),
    GOODS_STORE_ERROR(3007, "该商品未关联店铺或关联店铺错误"),
    ...
    ORDER_AGREEMENT_FAIL(6011, "签约信息保存失败"),
    ORDER_SAVE_FAIL(6012, "订单信息保存失败"),
    ORDER_COMB_SAVE_FAIL(6013, "子订单信息保存失败"),
    ORDER_DETAIL_SAVE_FAIL(6014, "订单明细保存失败"),
